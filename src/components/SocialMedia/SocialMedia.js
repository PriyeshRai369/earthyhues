    ...
    return (
        <>
            ...
            <div class={`icon-bar ${show && "hideIcon"} `}>
                ...
                <a href="tel:+918904278007" class="tripadvisor" target='_blank'><i class="fa fa-tripadvisor" aria-hidden="true"></i></a>
                <a href="tel:+918904278007" class="googleBusiness" target='_blank'><img src="assets/images/google.png" alt="" /></a>
            </div>
        </>
    )
}
